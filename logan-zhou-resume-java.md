...
Summary
-----------------------
* 2 years Java, 1 year Android, 2 years C# and WPF, 3 years SQL
(PostgreSQL, MySQL),   
3 years Python, 1 year Erlang, 1 year C++(but
more than you expected).
* Experience in trading system development.
* Experience in Linux development.
* Experience in cross platforms/compilers C++ development.
...
- Manages SMSes from/to specified contacts. Keeps them   
	secret. Notifies the user obscurely when a message received.
